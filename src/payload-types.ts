...
export interface Page {
  ...
  title: string;
  /**
   * URL path for this page (e.g., "join-us" or "hire-us")
   */
  slug: string;
  blocks: (
    | {
        ...
        primaryButton: {
          label: string;
          /**
           * Slug of the page to link to (e.g., "/join-us")
           */
          link: string;
        };
        secondaryButton: {
          label: string;
          /**
           * Slug of the page to link to (e.g., "/hire-us")
           */
          link: string;
        };
        id?: string | null;
    ...
    | {
        ...
        minHeight?: ('small' | 'medium' | 'large') | null;
        id?: string | null;
        blockName?: string | null;
        blockType: 'parallax';
      }
