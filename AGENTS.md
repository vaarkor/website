...
Always read and follow `STYLEGUIDE.md` at the repo root before making any UI, component, or styling changes. It defines the VÅR brand colors, typography, imagery treatment, component patterns, and tone of voice.
